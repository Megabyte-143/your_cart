    ...
    await FirebaseFirestore.instance
      ...
      products.docs.forEach((element) {
        ...
        _products.insert(
          0,
          Product(
            id: element.get('productID').toString(),
            title: element.get('productTitle').toString(),
            description: element.get('productDescription').toString(),
            price: double.parse(element.get('productPrice').toString()),
            imageUrl: element.get('imgUrl').toString(),
            brand: element.get('productBrand').toString(),
            productCategoryName: element.get('productCategory').toString(),
            quantity: int.parse(element.get('productQuantity').toString()),
            isPopular: true,
          ),
        );
      });
